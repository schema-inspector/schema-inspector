...
// Validation ------------------------------------------------------------------
	...
	var _applyRules = {
		...
		"escape-xml": function (post) {
			return post.replaceAll('&', '&amp;').replaceAll('<', '&lt;').replaceAll('>', '&gt;').replaceAll('"', '&quot;').replaceAll('\'', '&apos;');
		},
		"unescape-xml": function (post) {
			return post.replaceAll('&lt;', '<').replaceAll('&gt;', '>').replaceAll('&quot;', '"').replaceAll('&apos;', '\'').replaceAll('&amp;', '&');
		},
		...{ "encode-uri": encodeURI, "encode-uri-component": encodeURIComponent, "decode-uri": decodeURI, "decode-uri-component": decodeURIComponent }
	};
