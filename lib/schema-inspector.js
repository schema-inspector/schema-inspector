...
(function () {
  ...
  var _formats = {
    ...
    // 2022-11-20 - Switched to a different regex that was a bit more flexible
    // because added gmail: false to config for email-regex-safe:
    // const emailRegexSafe = require('email-regex-safe');
    // const regexString = emailRegexSafe({
    //   exact: true,
    //   returnString: true,
